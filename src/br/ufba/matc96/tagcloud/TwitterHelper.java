...
public class TwitterHelper
{
	...
	TwitterIndexer indexer;
	TwitterSearcher searcher;
	...
	public TwitterHelper()
	{
		...
		try
		{
			...
			indexer = new TwitterIndexer(this.indexDir);
		}
		catch (IOException e)
		{
			e.printStackTrace();
	...
	public TwitterHelper(String indexDir, String twitterHandle)
	{
	...
	public void createIndex() throws IOException, TwitterException
	{
		...
		searcher = new TwitterSearcher(this.indexDir);
	}
